        ...
        <section>
            ...
            <div class="info">
                ...
                <div class="info-blocks info-blocks-text">
                    <h3>Экскурсия-квест в комплексе Москва-сити</h2>
                    ...
                    <p>2 часа - 2300 руб.</p>
                    <a href="/pages/contacts.php" class="info-blocks-text-btn text-decoration-none">забронировать</a>
                </div>
            </div>
            <div class="info-revers">
                <div class="info-blocks info-blocks-text">
                    <h3>Легенды Сталинских высоток</h2>
            ...
            <div class="info">
                ...
                <div class="info-blocks info-blocks-text">
                    <h3>По следам Мастера и Маргариты</h2>
            ...
            <div class="info-revers">
                <div class="info-blocks info-blocks-text">
                    <h3>Легенды московского метро</h2>
